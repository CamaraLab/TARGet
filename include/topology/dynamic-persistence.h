    ...
    public StaticPersistence<Data_, ChainTraits_, ContainerTraits_, Element_, Comparison_>
{
    ...
    private:
        ...
        struct PairingChainsVisitor: public Parent::PairVisitorNoProgress
        {
                                        PairingChainsVisitor(Order& order, ConsistencyComparison ccmp, unsigned size):
                                            Parent::PairVisitorNoProgress(), order_(order), ccmp_(ccmp)       {}
            ...
            void                        finished(iterator i) const                      { Parent::PairVisitorNoProgress::finished(i); CountBy(cChainLength, i->chain.size()); }
